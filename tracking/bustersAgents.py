...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState: busters.GameState):
        ...
        # My Code
        closestList = [g.argMax() for g in livingGhostPositionDistributions]
        closestGhost = min(closestList, key=lambda g: self.distancer.getDistance(g, pacmanPosition))

        return min(legal, key=lambda a: self.distancer.getDistance(Actions.getSuccessor(pacmanPosition, a), closestGhost))
